...
Vue.component('app-main', __webpack_require__(35));
Vue.component('camo-navbar', __webpack_require__(43));
Vue.component('blog-list', __webpack_require__(50));
  ...
  return _c(
    ...
    _vm._l(_vm.blogs, function(blog) {
      return _c("div", { staticClass: "blog" }, [
        _c("a", { attrs: { href: blog.link } }, [_vm._v(_vm._s(blog.title))]),
        _vm._v(" "),
        _c("p", [
          _vm._v(_vm._s(blog.description.substring(0, _vm.maxDescriptSize))),
          _c(
            "span",
            {
              directives: [
                {
                  ...
                  expression: "blog.description.length > maxDescriptSize"
                }
              ]
            },
            [_vm._v("...")]
